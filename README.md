...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Douglas Fumê Blackout Envelopamento em domicílio em Fortaleza">
	<title>Medeiros Fumê Blackout em Fortaleza</title>
    <link rel="icon" sizes="32x32" href="favicon.png">
    <link rel="icon" sizes="16x16" href="favicon1.png">
    <link rel="icon" sizes="96x96" href="favicon2.png">
     <style>
     	h1{font-size:25pt;
		   color:#FFD700;
		}
...
<body>
    ...
    <hr>
        <figure>
		   <img src="img/blackout.jpg" alt="blackout" width="250">
           <img src="img/blackout1.jpg" alt="blackout 1" width="250">
		   <img src="img/blackout2.jpg" alt="blackout 2" width="250" height="250">
		   <img src="img/blackout3.jpg" alt="blackout 3" width="250">
    ...
    <hr>
        <figure>
               <img src="img/carro.jpg" alt="carro" width="250" height="250">
               <img src="img/carro1.jpg" alt="fumê 100%" width="250">
			   <img src="img/fumê2.jpg" alt="hilux" width="250">
			   <img src="img/carro3.jpg" alt="fumê 100%" width="250">
			   <img src="img/carro5.jpg" alt="fumê 100%" width="250">
			   <img src="img/carro6.jpg" title="fumê 100% e envelopamento" width="250">
			   <img src="img/carro7.jpg" alt="fumê 100%" width="250" height="250">
			   <img src="img/carro8.jpg" alt="carro" width="250">
			   <figcaption>Fotos de Trabalhos</figcaption>
		</figure>	   			   
	<article>		   
    ...
    <hr>
		...
		<hr>	
	    <fieldset>
          <h2><strong>MD Medeiros Fumê Blackout em domicílio em Forataleza</strong></h2>
	    ...
	    <figure>
             ...
             <img src="img/envelopamento2.jpg" alt="envelopamento" width="250">
             <img src="img/envelopamento3.jpg" alt="envelopamento" width="250">
             <img src="img/envelopamento4.jpg" alt="envelopamento" width="250">
             <img src="img/envelopamento5.jpg" alt="envelopamento" width="250">
             <img src="img/envelopamento6.jpg" alt="envelopamento" width="250">
             <img src="img/envelopamento15.jpg" alt="envelopamento" width="250">
             <img src="img/envelopamento16.jpg" alt="envelopamento" width="250">
			 <figcaption>Fotos de Trabalhos</figcaption>
        </figure>               
        <hr>		   
        <footer>
